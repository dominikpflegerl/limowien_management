...
<body class="bg-primary">
  ...
  <!--/.Navbar -->
	...
	<div align="center" class="text-left bg-white py-5">
  <form id="protocolform" class="px-5 mx-5" action="php/insert_protocol_drop.php" method="post">
  		...
  		<!-- DateTime Feld END -->
			...
			<div class="btn-group btn-row pt-3">
					...
					<button type="button" class="btn btn-dark"	onClick="ModalDamageList()">Schadenliste anzeigen</button>
			</div>
